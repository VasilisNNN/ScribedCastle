...
public class GamePad : MonoBehaviour
{
    ...
    public bool IsOptionsPressed { get { return previousFrame.options == false && currentFrame.options == true; } }
    ...
    public bool IsR2Pressed { get { return previousFrame.R2 == false && currentFrame.R2 == true; } }
    public bool IsL2Pressed { get { return previousFrame.L2 == false && currentFrame.L2 == true; } }
    ...
    private KeyCode L2BtnKeyCode;
    private KeyCode R2BtnKeyCode;
    ...
    private KeyCode RightStickPush;
    private KeyCode LeftStickPush;
    ...
    void Start()
    {
        ...
        L2BtnKeyCode = (KeyCode)Enum.Parse(typeof(KeyCode), "Joystick" + stickID + "Button6", true);
        R2BtnKeyCode = (KeyCode)Enum.Parse(typeof(KeyCode), "Joystick" + stickID + "Button7", true);
        ...
        RightStickPush = (KeyCode)Enum.Parse(typeof(KeyCode), "Joystick" + stickID + "Button10", true);

        LeftStickPush = (KeyCode)Enum.Parse(typeof(KeyCode), "Joystick" + stickID + "Button11", true);
    ...
    void TriggerShoulderButtons()
    {
        ...
        //currentFrame.L2 = Input.GetKey(L2BtnKeyCode);
        //currentFrame.R2 = Input.GetKey(R2BtnKeyCode);
