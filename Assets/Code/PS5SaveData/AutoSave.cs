...
namespace SaveData
{
    ...
    public class AutoSaveProcess
    {
        ...
        public static IEnumerator StartAutoSaveProcess(int userId, Dialogs.NewItem newItem, DirName autoSaveDirName, UInt64 newSaveDataBlocks, SaveDataParams saveDataParams,
                                                          FileOps.FileOperationRequest fileRequest, FileOps.FileOperationResponse fileResponse, bool backup, ErrorHandler errHandler, ulong requiredblocks)
        {
            SaveState currentState = SaveState.Begin;
            OnScreenLog.Add("StartAutoSaveProcess");
            ...
            int errorCode = 0;
               ...
               void ShowNoSpaceDialog(ulong requiredBlocks)
                {
                    try
                    {
                        ...
                        msg.SysMsgType = Dialogs.SystemMessageType.NoSpace;
            ...
            while (currentState != SaveState.Exit)
            {
                switch (currentState)
                {
                    case SaveState.Begin:
                        {
                            OnScreenLog.Add("StartAutoSaveProcess Begin");
                            ...
                            else
                            {
                                ...
                                {
                                    requiredblocks = mountResponse.RequiredBlocks;

                                    ShowNoSpaceDialog(requiredblocks);
                                }
                    ...
                    case SaveState.SaveFiles:
                        {
                            OnScreenLog.Add("StartAutoSaveProcess SaveState.SaveFiles");
                            // Do actual saving
                            ...
                            if (errorCode < 0)
                            {
                                ...
                                OnScreenLog.Add("errorCode 0 " + errorCode);
                            ...
                            else
                            {
                                ...
                                {
                                    yield return null;
                                    OnScreenLog.Add("fileResponse.Locked" + fileResponse.Locked);
                                ...
                                {
                                    currentState = SaveState.HandleError;
                                    OnScreenLog.Add("errorCode StartAutoSaveProcess" + errorCode);
                                }
                                else
                                {
        ...
        /// Start the auto-save process as a Unity Coroutine.
        /// </summary>
        public static IEnumerator StartAutoSaveLoadProcess(int userId, DirName dirName, FileOps.FileOperationRequest fileRequest, FileOps.FileOperationResponse fileResponse, ErrorHandler errHandler, ulong requiredblocks)
        {
            SaveState currentState = SaveState.Begin;
        ...
        internal static int UnmountSaveData(int userId, EmptyResponse unmountResponse, Mounting.MountPoint mp)
        {
            ...
            try
            {
                ...
                OnScreenLog.Add("UnmountSaveData");
                errorCode = 0;
            }
            catch
            {
