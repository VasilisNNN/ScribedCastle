...
public class SonySaveDataFileOps : MonoBehaviour, IScreen
{
    MenuLayout m_MenuFileOps;
    private SaveLoad SL;
    private MenuCustom _menu;
    private DayAndNight _DayAndNight;
    public bool ResponseFormed;
    public ExampleReadFilesResponse Response;
    void Start()
    {
        SetObjects();
            ...
            case FunctionTypes.FileOps:
                {
                    if (callbackEvent.Request is ExampleWriteFilesRequest)
                    {
                        ...
                        hasProcessedEvent = true; // Set flag to true after processing the event
                    }
    ...
    public void ExampleReadReponseOutput(ExampleReadFilesResponse response)
    {
        ...
        else OnScreenLog.Add("ExampleReadReponseOutput response is NULL");
    }
