...
public class SteamManager : MonoBehaviour {
	...
	protected virtual void Awake() {
		...
		try {
			...
			if (SteamAPI.RestartAppIfNecessary(new AppId_t(4063810))) {
		...
		if (!m_bInitialized) {
			//ogoDebug.LogError("[Steamworks.NET] SteamAPI_Init() failed. Refer to Valve's documentation or the comment above this line for more information.", this);
